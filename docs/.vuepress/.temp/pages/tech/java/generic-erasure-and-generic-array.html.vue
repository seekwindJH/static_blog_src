...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 错误的，运行时Map&lt;String, String>.class == Map.class</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-泛型数组" tabindex="-1"><a class="header-anchor" href="#_2-泛型数组" aria-hidden="true">#</a> 2. 泛型数组</h2>
